 ...
 * Slug: frosty-theme/footer-three-columns-contrast-background
 * Categories: footer
...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color has-small-font-size" style="margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p><a href="#"><?php echo esc_html__('Privacy Policy', 'frosty-theme'); ?></a> · <a href="#"><?php echo esc_html__('Terms of Service', 'frosty-theme'); ?></a> · <a href="#"><?php echo esc_html__('Contact Us', 'frosty-theme'); ?></a></p>
        <!-- /wp:paragraph -->
